...
$query = "select izin.*, guru.nama as namaguru, bk.nama as namabk
          from izin
          inner join guru on guru.id = izin.guruID
          inner join bk on bk.id = izin.bkID
          where siswaID = 2";
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="assets/images/logos/eazyn.png" width="130" alt="" />
          </a>
                  ...
                  <div class="card-body p-4">
                    ...
                    <div class="row align-items-center">
                      <div class="col-8">
                        ...
                        $query1 = "select count(id) as jumlah_izin from izin WHERE siswaID =2 and is_approved=2";
                        $sql = mysqli_query($is_connect, $query);
